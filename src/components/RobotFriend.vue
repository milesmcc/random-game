...
#body {
  animation: robot_bounce 2s ease-in-out 0s infinite alternate;
}

#head {
  animation: robot_bounce 2s ease-in-out 0.05s infinite alternate;
}

#arms {
  animation: robot_bounce 2s ease-in-out 0.1s infinite alternate;
}

#arms #left {
  transform-origin: center right;
  animation: arms_bounce_left 2s ease-in-out 0s infinite alternate;
}

#arms #right {
  transform-origin: center left;
  animation: arms_bounce_right 2s ease-in-out 0s infinite alternate;
}
...
#hover ellipse {
  transform-origin: center center;
  animation: shadow 2s ease-in-out 0s infinite alternate;
}
</style>